            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <div key={index} className="bg-dark-900 border border-dark-700 rounded-xl p-6 hover:border-primary-500/50 transition-all">
              ...
              <div className="mt-8 bg-gradient-to-br from-primary-500/10 to-secondary-500/10 border border-primary-500/20 rounded-xl p-6">
            ...
            <div className="lg:col-span-2">
              <div className="bg-dark-900 border border-dark-700 rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-primary-500 to-secondary-500 text-white py-4 px-6 rounded-lg font-semibold text-lg hover:shadow-xl hover:shadow-primary-500/30 transition-all flex items-center justify-center gap-2"
                  >
                    提交留言 <Send size={20} />
                  </button>
                </form>
      ...
      <section className="py-20 bg-dark-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">公司位置</h2>
            <p className="text-gray-400">欢迎您来公司考察参观</p>
          </div>
          <div className="bg-dark-800 border border-dark-700 rounded-2xl overflow-hidden h-96 flex items-center justify-center">
            <div className="text-center">
              <MapPin className="w-16 h-16 text-primary-500 mx-auto mb-4" />
              <p className="text-gray-400 text-lg">浙江省宁波市鄞州区科技园区</p>
